import time, socket, sys, threading, util
...
class Node:
    ...
    def start(self,vizinhos):
        ...
        try:
            ...
            #             print(f'SENT SHUTDOWN SIGNAL TO {ip}')
            ...
            try:
                ...
                while True:
                    ...
                    if not data:
                        ...
                        print(f'{util.bcolors.OKBLUE}INFO: RECEIVED PACKET{util.bcolors.ENDC}')
    ...
    def open_send_tcp_socket(self,conn,addr):
        while data := conn.recv(1024):
                if not data:
                    ...
                    #     print(f'INFO : NEIGHBOUR {origin_ip} DISCONNECTED')
